...
const Contact = () => {
    return (
      <main>
        ...
        <p className='pl-2'>
          <img src='/tglogo.webp' alt="Telegram Logo" className="h-3 inline-block align-middle mr-2"/>
        ...
        <p className='pl-2'>
          <img src='/discordlogo.svg' alt="Discord Logo" className="h-3 inline-block align-middle mr-2"/>
